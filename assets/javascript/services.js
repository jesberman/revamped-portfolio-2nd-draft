...
//******Code used to give functionality to the plus buttons on the services page**** */

var clickValue = 0;

$(".website-design-and-development-plus1").click(function () {
  if (clickValue === 0) {
    $(".website-design-and-development-plus1").addClass("plus-click");
    $(".website-design-and-development-plus1").addClass("rotate");
    $(".website-design-and-development-plus1-text").addClass("plus-click");
    $(".website-design-and-development-plus1-text-hidden").addClass("reveal");

    clickValue = 1;
  }
  else if (clickValue === 1){
    $(".website-design-and-development-plus1").removeClass("plus-click");
    $(".website-design-and-development-plus1").removeClass("rotate");
    $(".website-design-and-development-plus1-text").removeClass("plus-click");
    $(".website-design-and-development-plus1-text-hidden").removeClass("reveal");
...
$(".website-design-and-development-plus2").click(function () {
  if (clickValue2 === 0) {
    $(".website-design-and-development-plus2").addClass("plus-click");
    $(".website-design-and-development-plus2").addClass("rotate");
    $(".website-design-and-development-plus2-text").addClass("plus-click");
    $(".website-design-and-development-plus2-text-hidden").addClass("reveal");

    clickValue2 = 1;
  }
  else if (clickValue2 === 1){
    $(".website-design-and-development-plus2").removeClass("plus-click");
    $(".website-design-and-development-plus2").removeClass("rotate");
    $(".website-design-and-development-plus2-text").removeClass("plus-click");
    $(".website-design-and-development-plus2-text-hidden").removeClass("reveal");
    clickValue2 = 0;
  }
})
...
$(".content-writing-plus").click(function () {
  if (clickValue3 === 0) {
    $(".content-writing-plus").addClass("plus-click2");
    $(".content-writing-plus").addClass("rotate");
    $(".content-writing-plus-text").addClass("plus-click2");
    $(".content-writing-plus-text-hidden").addClass("reveal");

    clickValue3 = 1;
  }
  else if (clickValue3 === 1){
    $(".content-writing-plus").removeClass("plus-click2");
    $(".content-writing-plus").removeClass("rotate");
    $(".content-writing-plus-text").removeClass("plus-click2");
    $(".content-writing-plus-text-hidden").removeClass("reveal");
    clickValue3 = 0;
  }
})
